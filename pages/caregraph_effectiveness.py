...
if 'state2' not in st.session_state:
    ...
    st.session_state.situation2 = (
        "할머니 생신 잔치에 참석한 자폐인 가족은 친척들과 이웃들로 붐빈 낯선 환경에서 불안 증상을 보이다가, 결국 울음을 터뜨리며 타인과의 상호작용이나 행사 참여를 유도하는 언어나 신체적 시도에 강한 거부 반응을 보이고, 가구 뒤에 숨거나 귀를 막는 등의 감각 과부하 행동을 나타냈음"
    )
