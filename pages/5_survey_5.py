...
if st.button("제출"):
    ...
    filepath = os.path.join(user_dir, "survey5.csv")
...
with col1:
    if st.button("◀ 이전 페이지"):
        st.switch_page("pages/4_survey_4.py")       # pages/home.py (확장자 제외)
with col2:
    if st.button("다음 페이지 ▶"):
        st.switch_page("pages/6_improve_survey.py")    # pages/survey2.py (확장자 제외)
