...
Survey_3의 목적은 중재 전략이 얼마나 적절하게 제시 되었는지를 측정하는 것에 목적이 있습니다.
...
with col1:
    if st.button("◀ 이전 페이지"):
        st.switch_page("pages/survey_2.py")       # pages/home.py (확장자 제외)
with col2:
    if st.button("다음 페이지 ▶"):
        st.switch_page("pages/survey_4.py")    # pages/survey2.py (확장자 제외)
